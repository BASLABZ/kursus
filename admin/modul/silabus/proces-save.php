<?php
error_reporting(0);
$var_syllabus=htmlentities($_POST['syllabus_title']); //htmlentities() sebuah fungsi untuk merubah semua tag HTML menjadi text biasa
...
$query="INSERT INTO ref_syllabus VALUES 
        ('',
            '".$var_syllabus."',
            '".$var_date."',
            '".$nama_file."')";
...
if ($result){
    ...
    //header('Location: admin_area.php?page=silabus.display');
