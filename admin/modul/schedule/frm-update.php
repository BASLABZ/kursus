<?php
  ...
  $var_roomsId=$_GET['id'];
  $sql="select * from ref_rooms where room_id='".$var_roomsId."'";
  //echo $sql; exit;
                ...
                <div class="demo-form-wrapper">
                  <br>
                   <form id="defaultForm" method="post" action="?page=rooms.proces-update" enctype="multipart/form-data">
                    <input type="hidden" name="hidden_roomsid" value="<?php echo $data['room_id']; ?>"/>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <textarea name="frm_roomsnote" class="form-control" rows="3"><?php echo $data['room_notes'] ?></textarea>
                      </div>
