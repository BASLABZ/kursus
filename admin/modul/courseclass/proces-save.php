...
error_reporting(0);
$var_categoryName=htmlentities($_POST['frm_categoryname']); //htmlentities() sebuah fungsi untuk merubah semua tag HTML menjadi text biasa
...
$query="INSERT INTO ref_courseclass VALUES 
        ('',
            '".$var_categoryName."')";
         //  echo $query;
         //  exit;
