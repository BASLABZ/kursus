<?php
error_reporting(0);
$var_matapelajaran=htmlentities($_POST['frm_namabahan']); //htmlentities() sebuah fungsi untuk merubah semua tag HTML menjadi text biasa
$var_syllabusTitle=htmlentities($_POST['frm_syllabustitle']);
$var_description=htmlentities($_POST['frm_bahannote']);
...
$query="INSERT INTO ref_matapelajaran(syllabus_id, matapelajaran_name, matapelajaran_description) VALUES 
        (
            '".$var_syllabusTitle."',
            '".$var_matapelajaran."',
            '".$var_description."')";
