<?php
  ...
  $var_courseId=$_GET['id'];
  $sql="select * from tbl_courses where course_id='".$var_courseId."'";
  //echo"<center>".$sql."</center>"; exit;
    ...
    <div class="layout-content-body">
      <div class="title-bar">
        <h1 class="title-bar-title">
          <span class="d-ib">Edit Kursus</span>
        </h1>
            ...
            <div class="card-body">
              ...
              <div class="col-sm-6 col-sm-offset-3">
                <div class="demo-form-wrapper">
                  <br>
                  <form id="defaultForm" method="post" action="?page=course.proces-update" enctype="multipart/form-data">
                  <input type="hidden" name="hidden_courseid" value="<?php echo $data['course_id']; ?>"/>
                  <div class="form-group">
                    <label for="ruangan">Nama Kursus Pelatihan</label>
                    <input name="frm_coursename" class="form-control" type="text" value="<?php echo $data['course_title']; ?>">
                  </div>

                  <div class="form-group">
                    <label>Detail Pelatihan</label>
                    <input name="frm_coursedetail" class="form-control" type="text" value="<?php echo $data['course_detail'] ;?>">
                  </div>

                  <div class="form-group">
                    <label>Harga Pelatihan</label>
                    <input name="frm_courseprice" class="form-control" type="text" value="<?php echo $data['course_price'] ;?>">
                  </div>

                  <div class="form-group">
                    <label>Kuota Pelatihan</label>
                    <input name="frm_coursequota" class="form-control" type="text" value="<?php echo $data['course_quota'] ;?>">
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <select name="frm_coursecategory" class="form-control" required="">
                        ...
                        ?>
                        <option selectedvalue='<?php echo $varId_class ; ?>'><?php echo $varNama_class; ?></option>
                        <?php 
                          }//tutup while
                        ?>
                  ...
                  <div class="form-group">
                    <label>Trainer Pelatihan</label><br>
                      ...
                      <label class="custom-control custom-control-primary custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="trainer[]" value="<?php echo $varId_trainer; ?>" checked>
                  ...
                  <div class="form-group">
                    <label>Bahan Pelajaran&Pelatihan</label><br>
                      ...
                      <label class="custom-control custom-control-primary custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="matapelajaran[]" value="<?php echo $varId_bahan; ?>" checked>
                          <span class="custom-control-indicator"></span>
                  ...
                  <div class="form-group">
                    <label>Materi Pelatihan</label><br>
                      ...
                      <label class="custom-control custom-control-primary custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="coursematerial[]" value="<?php echo $varId_materi; ?>" checked>
                          <span class="custom-control-indicator"></span>
